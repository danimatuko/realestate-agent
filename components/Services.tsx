        ...
        <div className='flex flex-wrap items-center'>
          <div className='grow-0 shrink-0 basis-auto w-full lg:w-5/12 mb-12 lg:mb-0 md:px-6'>
            <div
              ...
              <Image
                src='https://images.pexels.com/photos/2386675/pexels-photo-2386675.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
                alt=''
                width={800}
                height={800}
              />
          ...
          <div className='grow-0 shrink-0 basis-auto w-full lg:w-7/12 md:px-6'>
            <div className='flex mb-12'>
              <div className='shrink-0'>
                <div className='p-4 rounded-md shadow-lg bg-black bg-black'>
                  <svg
            ...
            <div className='flex mb-12'>
              <div className='shrink-0'>
                <div className='p-4 rounded-md shadow-lg bg-black'>
                  <svg
                    className='w-5 h-5 text-white'
                    xmlns='http://www.w3.org/2000/svg'
                    viewBox='0 0 512 512'>
            ...
            <div className='flex mb-12'>
              <div className='shrink-0'>
                <div className='p-4 rounded-md shadow-lg bg-black text-black'>
                  <svg
                    className='w-5 h-5 text-white'
                    xmlns='http://www.w3.org/2000/svg'
                    viewBox='0 0 640 512'>
